...
<template>
  <div
    class="flex min-h-[70vh] w-full flex-col items-center px-5 py-10 sm:py-10 sm:pb-16"
  >
    <h1 class="mt-1 text-center text-3xl leading-10">
      Suggest a Movie Night&nbsp;Theme!
    </h1>

    <form
      class="mt-5 w-full max-w-sm space-y-5 rounded-lg bg-violet-200 p-4 sm:mt-8"
    >
      <FormInput
